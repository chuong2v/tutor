...
ActiveRecord::Schema.define(version: 20150705093939) do
  ...
  create_table "class_times", force: :cascade do |t|
    ...
    t.integer  "dow_id",     limit: 4
    t.integer  "tod_id",     limit: 4
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
  end
  ...
  create_table "teaching_times", force: :cascade do |t|
    t.integer  "td_id",      limit: 4
    t.integer  "dow_id",     limit: 4
    t.integer  "tod_id",     limit: 4
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
  ...
  create_table "tutor_levels", force: :cascade do |t|
    t.integer  "level_id",   limit: 4
    t.integer  "td_id",      limit: 4
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "age",                    limit: 4,   default: 18, null: false
